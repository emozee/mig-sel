...
import { Menu, FileText, MapPin, Clock, MoveRight, CheckCheck } from 'lucide-react';
import { cn } from '@/lib/utils';
import { InspectorSidebar, type InspectorNavView } from '@/components/layout/inspector-sidebar';
...
const iconMap: Record<InspectorNavView, typeof FileText> = {
  reporting: FileText,
  reports: FileText,
};
...
export const InspectorPage = () => {
  ...
  const pageMeta: Record<InspectorNavView, { title: string; description: string }> = {
    reporting: {
      ...
      description: 'Submit waste collection records for inspection',
    },
    reports: {
      title: 'My Reports',
      ...
      <div className="flex flex-1 flex-col md:ml-60">
        ...
        <main className="flex-1 overflow-auto">
          ...
          >
            ...
            {activeView === 'reporting' && <WasteReportingForm />}
