  ...
  return (
    <div className="space-y-4">
                      ...
                      <>
                        <td className="px-4 py-3">
                          {complaint.approved ? (
                            ...
                            <span
                              className="inline-block cursor-not-allowed rounded-full px-2 py-0.5 text-[10px] font-bold tracking-wide uppercase opacity-70"
                              title="Approve this report to change its urgency"
                              style={{
                                backgroundColor: URGENCY_BADGE[complaint.urgency]?.bg || '#f3f4f6',
                                color: URGENCY_BADGE[complaint.urgency]?.text || '#1f2937',
                              }}
                        ...
                        <td className="px-4 py-3">
                          {complaint.approved ? (
                            ...
                            <span
                              ...
                              title="Approve this report to change its status"
                            >
                          ...
                          <div className="flex items-center gap-1.5">
                            {!complaint.approved && (
                              <button
                                ...
                                className="inline-flex cursor-pointer items-center gap-1 rounded-full bg-amber-600 px-3 py-1.5 text-xs font-bold text-white transition-all hover:bg-amber-700 disabled:opacity-50"
                                title="Approve this report to unlock status and urgency"
                              >
                ...
                <div className="flex gap-3">
                  {activeTab === 'unapproved' && (
                    <input
                      ...
                      className="mt-8 h-4 w-4 shrink-0 cursor-pointer rounded border-gray-300 text-amber-600 focus:ring-amber-500"
                    />
                  )}
                  <button
                    type="button"
                  ...
                  >
                    {complaint.image_url ? (
                      <img
                        ...
                        alt={complaint.title}
                        loading="lazy"
                        className="h-20 w-20 cursor-pointer rounded-lg border border-slate-200/60 object-cover shadow-xs"
                      />
                    ) : (
                      <div className="flex h-20 w-20 items-center justify-center rounded-lg border border-dashed border-slate-200 bg-slate-50">
                        <svg
                          className="h-5 w-5 text-slate-300"
                          fill="none"
                          viewBox="0 0 24 24"
                  ...
                  >
                    ...
                    <div className="mt-1.5 flex flex-wrap items-center gap-1.5">
                      <span
                        ...
                        style={{
                          backgroundColor: CATEGORY_COLORS[complaint.category]
                            ? `${CATEGORY_COLORS[complaint.category]}1a`
                            : '#f3f4f6',
                      ...
                      {complaint.ai_label && (
                        <span
                          className="rounded border border-amber-300 bg-amber-50 px-1.5 py-0.5 text-[10px] font-bold tracking-wide text-amber-700 uppercase"
                          title="AI flagged this photo as non-grievance"
                        >
                          AI: {complaint.ai_label}
                        </span>
                ...
                {activeTab !== 'unapproved' ? (
                      ...
                      {complaint.approved ? (
                        <>
                          <select
                            ...
                            aria-label={`Urgency for ${complaint.title}`}
                            className="min-w-0 flex-1 cursor-pointer appearance-none rounded-lg border bg-white px-2 py-1.5 text-[11px] font-bold tracking-wide uppercase outline-none"
                            style={{
                              borderColor: URGENCY_BADGE[complaint.urgency]?.text || '#c2c9bb',
                              backgroundColor: URGENCY_BADGE[complaint.urgency]?.bg || '#f3f4f6',
                              color: URGENCY_BADGE[complaint.urgency]?.text || '#1f2937',
                          ...
                          <select
                            ...
                            className={`min-w-0 flex-1 cursor-pointer appearance-none rounded-lg border px-2 py-1.5 text-[11px] font-bold tracking-wide uppercase outline-none ${
                              complaint.status === 'resolved'
                                ? 'border-emerald-500 bg-emerald-50 text-emerald-500'
                                : complaint.status === 'in-progress'
                                  ? 'border-blue-500 bg-blue-50 text-blue-500'
                    ...
                    {complaint.approved ? (
                      ...
                      <div className="mt-2.5 grid grid-cols-2 gap-2">
                        <button
                          ...
                          className="inline-flex cursor-pointer items-center justify-center gap-1 rounded-full bg-amber-600 px-3 py-1.5 text-xs font-bold text-white transition-all hover:bg-amber-700 disabled:opacity-50"
                        >
                          <UserCheck className="h-3 w-3" />
                          {approveComplaint.isPending && approveComplaint.variables === complaint.id
                            ? '...'
                            : 'Approve'}
                        </button>
                        <button
                          type="button"
                          onClick={() => setDisapproveConfirmId(complaint.id)}
                          className="inline-flex cursor-pointer items-center justify-center gap-1 rounded-full bg-red-100 px-3 py-1.5 text-xs font-bold text-red-700 transition-all hover:bg-red-200"
                          title="Permanently delete this report"
                        >
                          <Trash2 className="h-3 w-3" />
                          Reject
                  ...
                  <div className="mt-2.5 grid grid-cols-2 gap-2">
                    ...
                    <button
                      type="button"
                      onClick={() => setDisapproveConfirmId(complaint.id)}
                      className="inline-flex cursor-pointer items-center justify-center gap-1 rounded-full bg-red-600 px-3 py-1.5 text-xs font-bold text-white transition-all hover:bg-red-700"
                      title="Permanently delete this report"
                    >
                      <Trash2 className="h-3 w-3" />
                      Reject
      ...
      {previewComplaint &&
        (() => {
          ...
          return (
            ...
            >
              <div
                className="max-h-[90dvh] w-full max-w-lg overflow-y-auto rounded-xl border bg-white p-4 shadow-xl sm:mx-4 sm:p-6"
                    ...
                    {previewComplaint.approved ? (
                      <select
                        ...
                        onChange={(e) => {
                          ...
                          setPreviewComplaint(
                            (prev) =>
                              prev && { ...prev, status: e.target.value as ComplaintStatus },
                          );
                        }}
                        className={`cursor-pointer rounded-full px-2 py-0.5 text-[10px] font-bold tracking-wide uppercase outline-none ${
      ...
      {bulkDisapprove && (
        ...
        >
          <div
            className="max-h-[90dvh] w-full max-w-sm overflow-y-auto rounded-xl border bg-white p-6 shadow-xl sm:mx-4"
            onClick={(e) => e.stopPropagation()}
          >
